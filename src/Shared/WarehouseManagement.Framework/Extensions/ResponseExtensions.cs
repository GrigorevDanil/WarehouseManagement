...
namespace WarehouseManagement.Framework.Extensions;
...
public static class ResponseExtensions
{
    ...
    {
        if (result.IsSuccess)
            return new OkObjectResult(Envelope<T>.Ok(result.Value));
        ...
        var envelope = Envelope<T>.Error(result.Error);
    ...
    public static ActionResult ToResponse(this UnitResult<ErrorList> result)
    {
        ...
        var envelope = Envelope<object?>.Error(result.Error);
