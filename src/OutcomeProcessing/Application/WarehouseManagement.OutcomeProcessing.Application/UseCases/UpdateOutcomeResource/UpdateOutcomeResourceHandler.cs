...
public class UpdateOutcomeResourceHandler : ICommandHandler<Guid, UpdateOutcomeResourceCommand>
{
    ...
    private readonly IValidator<UpdateOutcomeResourceCommand> _validator;
    
    private readonly ILogger<UpdateOutcomeResourceHandler> _logger;
    
    public UpdateOutcomeResourceHandler(
        ...
        IValidator<UpdateOutcomeResourceCommand> validator,
        ILogger<UpdateOutcomeResourceHandler> logger)
    {
    ...
    public async Task<Result<Guid, ErrorList>> Handle(UpdateOutcomeResourceCommand command, CancellationToken cancellationToken = default)
    {
        ...
        outcomeResource.UpdateMainInfo(
            resourceId,
            unitId,
        ...
        _logger.LogInformation("OutcomeResource by ${id} has been updated", command.OutcomeResourceId);
