...
dotnet-ef migrations remove -c WriteDbContext -p ./src/BalanceManagement/Infrastructure/WarehouseManagement.BalanceManagement.Infrastructure/ -s ./src/WarehouseManagement.API/
dotnet-ef migrations remove -c WriteDbContext -p ./src/OutcomeProcessing/Infrastructure/WarehouseManagement.OutcomeProcessing.Infrastructure/ -s ./src/WarehouseManagement.API/
...
dotnet-ef migrations add BalanceManagement_Initial -c WriteDbContext -p ./src/BalanceManagement/Infrastructure/WarehouseManagement.BalanceManagement.Infrastructure/ -s ./src/WarehouseManagement.API/
dotnet-ef migrations add OutcomeProcessing_Initial -c WriteDbContext -p ./src/OutcomeProcessing/Infrastructure/WarehouseManagement.OutcomeProcessing.Infrastructure/ -s ./src/WarehouseManagement.API/
...
dotnet-ef database update -c WriteDbContext -p ./src/BalanceManagement/Infrastructure/WarehouseManagement.BalanceManagement.Infrastructure/ -s ./src/WarehouseManagement.API/
dotnet-ef database update -c WriteDbContext -p ./src/OutcomeProcessing/Infrastructure/WarehouseManagement.OutcomeProcessing.Infrastructure/ -s ./src/WarehouseManagement.API/
